defmodule PhxMolbindWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxMolbindWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxMolbindWeb.Gettext, "errors", msg, opts)
    end
  end
